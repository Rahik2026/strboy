    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-14">
          <h2 className="font-display text-2xl md:text-3xl lg:text-4xl font-bold text-ink-950 mb-3">
            What Our Customers Say
          </h2>
          <p className="text-ink-500 text-sm md:text-base max-w-xl mx-auto">
            Real reviews from the STARBOY BD community across Bangladesh.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex gap-0.5 mb-3">
                {Array.from({ length: 5 }).map((_, s) => (
                  <Star
                    key={s}
                    className={`w-4 h-4 ${s < review.rating ? "text-brand-500 fill-brand-500" : "text-ink-200"}`}
                  />
                ))}
              </div>
